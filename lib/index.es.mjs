...
var css = ".rsw-editor{display:flex;flex-direction:column;min-height:100px;overflow:hidden;position:relative}.rsw-ce{border:1px solid #eeeff3;border-radius:6px;flex:1 0 auto;max-height:164px;min-height:164px;outline:none;overflow-x:hidden;overflow-y:scroll;padding:58px 8px 4px 28px;position:relative}.wrapper{background-color:#fff;height:50px;left:24px;position:absolute;top:2px;width:95%;z-index:1}.rsw-ce ol,.rsw-ce ul{padding-inline-start:18px}.rsw-ce[contentEditable=true]:empty:not(:focus):before{color:grey;content:attr(placeholder)}.rsw-html{border:none;font-family:Inter,sans-serif}.rsw-ce:focus{border:2px solid #7c91fa}.rsw-separator{background:#eeeff3;height:24px;margin-left:6px;margin-right:6px;width:1px}.rsw-dd{box-sizing:border-box;outline:none}.rsw-btn{align-items:center;background-color:transparent;border:0;border-radius:6px;cursor:pointer;display:flex;font-size:1em;height:24px;justify-content:center;outline:none;padding:0;width:24px;z-index:1}.rsw-btn:hover{background:#e6eafe}.rsw-btn:hover .alignCenterIcon{color:#4062f4}.rsw-btn .alignCenterIcon{color:#393f63}.rsw-btn[data-active=true]{background:#e6eafe}.rsw-btn[data-active=true] .alignCenterIcon{color:#4062f4}.rsw-toolbar{align-items:center;background-color:#fafbfc;border:1px solid #f4f5f8;border-radius:6px;display:flex;gap:4px;height:32px;padding-left:4px;position:absolute;right:0;top:12px;width:100%;z-index:1}li::marker{text-align:center}";
n(css,{});
...
function findListElement(node) {
    var _a, _b;
    var currentElement = node;
    while (currentElement) {
        if (currentElement) {
            if ((currentElement === null || currentElement === void 0 ? void 0 : currentElement.nodeType) === Node.ELEMENT_NODE && ((_a = currentElement === null || currentElement === void 0 ? void 0 : currentElement.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === 'ul' || ((_b = currentElement === null || currentElement === void 0 ? void 0 : currentElement.tagName) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === 'ol') {
                return currentElement;
            }
            currentElement = currentElement === null || currentElement === void 0 ? void 0 : currentElement.parentNode;
        }
    }
    return null;
}
            ...
            if (typeof command === 'function') {
                ...
                if (selection && selection.rangeCount > 0) {
                    ...
                    if (command === 'justifyCenter') {
                        if (parentElement) {
                            var listElement = findListElement(parentElement);
                            if (!listElement && ((_a = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === 'li') {
                            ...
                            if (listElement) {
                                ...
                                if (((_b = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === 'div' || ((_c = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _c === void 0 ? void 0 : _c.toLowerCase()) === 'span' || ((_d = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _d === void 0 ? void 0 : _d.toLowerCase()) === 'b' || ((_e = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _e === void 0 ? void 0 : _e.toLowerCase()) === 'u' || ((_f = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _f === void 0 ? void 0 : _f.toLowerCase()) === 'i') {
                                    document.execCommand(command);
                                }
                            }
                        }
                        ...
                        if (parentElement) {
                            ...
                            // }
                            var listElement = findListElement(parentElement);
                            if (!listElement && ((_g = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _g === void 0 ? void 0 : _g.toLowerCase()) === 'li') {
                                listElement = findListElement(range.commonAncestorContainer);
                            }
                            if (listElement) {
                                ...
                                if (((_h = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _h === void 0 ? void 0 : _h.toLowerCase()) === 'div' || ((_j = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _j === void 0 ? void 0 : _j.toLowerCase()) === 'span' || ((_k = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _k === void 0 ? void 0 : _k.toLowerCase()) === 'b' || ((_l = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _l === void 0 ? void 0 : _l.toLowerCase()) === 'u' || ((_m = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _m === void 0 ? void 0 : _m.toLowerCase()) === 'i') {
                                    document.execCommand(command);
                                }
                            }
                        }
                        ...
                        if (parentElement) {
                            ...
                            // }
                            var listElement = findListElement(parentElement);
                            if (!listElement && ((_o = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _o === void 0 ? void 0 : _o.toLowerCase()) === 'li') {
                                listElement = findListElement(range.commonAncestorContainer);
                            }
                            if (listElement) {
                                // if(listElement.tagName.toLowerCase() === 'ul' || 'ol'){
                                ...
                                if (((_p = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _p === void 0 ? void 0 : _p.toLowerCase()) === 'div' || ((_q = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _q === void 0 ? void 0 : _q.toLowerCase()) === 'span' || ((_r = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _r === void 0 ? void 0 : _r.toLowerCase()) === 'b' || ((_s = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _s === void 0 ? void 0 : _s.toLowerCase()) === 'u' || ((_t = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _t === void 0 ? void 0 : _t.toLowerCase()) === 'i') {
                                    document.execCommand(command);
                                }
                            }
                        }
...
function Toolbar(props) {
    return (React.createElement("div", { className: 'wrapper' },
        React.createElement("div", __assign({}, props, { className: "rsw-toolbar" }))));
}
