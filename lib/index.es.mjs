            ...
            if (typeof command === 'function') {
                ...
                if (selection && selection.rangeCount > 0) {
                    ...
                    if (command === 'justifyCenter') {
                        if (parentElement) {
                            if (((_a = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === 'div') {
                                document.execCommand(command);
                            }
                            var listElement = findListElement(parentElement);
                            if (!listElement && ((_b = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === 'li') {
                        ...
                        if (parentElement) {
                            if (((_c = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _c === void 0 ? void 0 : _c.toLowerCase()) === 'div') {
                                document.execCommand(command);
                            }
                            var listElement = findListElement(parentElement);
                            if (!listElement && ((_d = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _d === void 0 ? void 0 : _d.toLowerCase()) === 'li') {
                                listElement = findListElement(range.commonAncestorContainer);
                            }
                            if (listElement) {
                        ...
                        if (parentElement) {
                            if (((_e = parentElement === null || parentElement === void 0 ? void 0 : parentElement.tagName) === null || _e === void 0 ? void 0 : _e.toLowerCase()) === 'div') {
                                document.execCommand(command);
                            }
                            var listElement = findListElement(parentElement);
